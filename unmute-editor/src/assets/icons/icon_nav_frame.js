...
const NavFrameIcon = ({color, size = 33, className = ''}) => {
  return (
    <div className={className}>
      <svg width={size} height={size} viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_6_8864)">
          <mask id="mask0_6_8864" maskUnits="userSpaceOnUse" x="2" y="5" width="28"
                height="23">
            <path d="M29.5 5.93491H2.5V27.0651H29.5V5.93491Z" fill="white"/>
          </mask>
          <g mask="url(#mask0_6_8864)">
            <path
